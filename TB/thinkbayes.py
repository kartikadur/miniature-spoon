...
class Pmf(_DictWrapper):
    ...
    ## Adding code for Percentile to make things easy for me -- kartik
    def Percentile(self, percent = 50):
        cdf = self.MakeCdf()
        return cdf.Percentile(percent)

    def Median(self):
        return self.Percentile(50)

    ## End Adding code for convenience --kartik
